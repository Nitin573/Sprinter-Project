...
const ContestDetail = () => {
    ...
    const handleChange = (e) => {
      ...
      const handleSubmit = async (e) => {
        e.preventDefault();
        const token = "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY1NDI1ZDlhNjk2MjhlYzM5MmNhNjYyYSIsImlhdCI6MTY5OTM3MzIyMSwiZXhwIjoxNjk5Mzc2ODIxfQ.uATGG868rYZXZy6fyY1iB0b3aBnpXqX0m9am6jX43iM"; // Replace with your actual bearer token
