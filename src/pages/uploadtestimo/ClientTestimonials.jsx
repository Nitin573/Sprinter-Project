...
const ClientTestimonials = () => {
  ...
  useEffect(() => {
    ...
    fetch('https://hotel-project.onrender.com/S-printer-App/TestimonialRoute/allTestimonials', {
      method: 'GET',
      headers: {
        'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY1NDI1ZDlhNjk2MjhlYzM5MmNhNjYyYSIsImlhdCI6MTY5OTM3MzIyMSwiZXhwIjoxNjk5Mzc2ODIxfQ.uATGG868rYZXZy6fyY1iB0b3aBnpXqX0m9am6jX43iM',
      },
    })
